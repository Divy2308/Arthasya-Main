      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 mb-24 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            End-to-end accounting, BAS preparation, and ATO compliance for Australian enterprises.
          </p>
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-10 md:p-16 shadow-sm mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6 space-y-8 text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Australian Business Compliance</h2>
              <p className="text-slate-600 text-base md:text-lg">
                Ensure your business stays compliant with the Australian Taxation Office (ATO). We prepare detailed financial accounts, reconcile GST, compile and lodge Business Activity Statements (BAS), and coordinate corporate tax preparations.
              </p>
            </div>
            <div className="lg:col-span-6 grid grid-cols-2 gap-6">
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                <div className="text-4xl font-bold text-slate-800">ATO</div>
                <div className="text-xs text-slate-500 uppercase font-bold">Standard Compliance</div>
              </div>
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                <div className="text-4xl font-bold text-slate-800">BAS</div>
                <div className="text-xs text-slate-500 uppercase font-bold">Lodge Preparation</div>
              </div>
            </div>
          </div>
        </div>
