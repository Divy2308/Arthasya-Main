...
export default function XeroQuickBooks() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 mb-24 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            Certified software experts managing, cleaning, and optimizing your cloud accounting files.
          </p>
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-10 md:p-16 shadow-sm mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6 space-y-8 text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Cloud Platform Experts</h2>
              <p className="text-slate-600 text-base md:text-lg">
                Harness the full power of modern cloud accounting software. We handle initial setups, platform migrations, transaction categorization, bank feeds, and custom reporting.
              </p>
            </div>
            <div className="lg:col-span-6 grid grid-cols-2 gap-6">
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                <div className="text-4xl font-bold text-slate-800">Certified</div>
                <div className="text-xs text-slate-500 uppercase font-bold">ProAdvisors & Partners</div>
              </div>
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                <div className="text-4xl font-bold text-slate-800">100%</div>
                <div className="text-xs text-slate-500 uppercase font-bold">Cloud-Based Flow</div>
              </div>
            </div>
          </div>
        </div>
