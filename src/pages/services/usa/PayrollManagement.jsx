      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 mb-24 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            Accurate payroll processing, compliance reporting, benefits administration, and direct deposits.
          </p>
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-10 md:p-16 shadow-sm mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6 space-y-8 text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Reliable Payroll Operations</h2>
              <p className="text-slate-600 text-base md:text-lg">
                Ensure timely compensation for your staff, manage federal and state tax deductions, and keep audit trails seamless.
              </p>
            </div>
            <div className="lg:col-span-6 grid grid-cols-2 gap-6">
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                ...
                <div className="text-xs text-slate-500 uppercase font-bold">On-time processing</div>
              </div>
              <div className="bg-slate-50 border rounded-2xl p-6 text-center">
                <div className="text-4xl font-bold text-slate-800">Zero</div>
                <div className="text-xs text-slate-500 uppercase font-bold">Filing penalties</div>
              </div>
            </div>
          </div>
        </div>
