    ...
    <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-32 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold font-display text-slate-800">Bank-Grade Compliance</h4>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold font-display text-slate-800">Timezone Sync</h4>
        ...
        <div className="lg:col-span-5 grid grid-cols-1 gap-6 w-full">
          <div className="bg-white border border-slate-200/60 rounded-3xl p-6 relative overflow-hidden group shadow-sm hover:border-slate-300 transition-all duration-300">
            <div className="text-xs text-slate-500 font-semibold mb-1">01 / Talent Quality</div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-3xl p-6 relative overflow-hidden group shadow-sm hover:border-slate-300 transition-all duration-300">
            <div className="text-xs text-slate-500 font-semibold mb-1">02 / Dynamic Scaling</div>
